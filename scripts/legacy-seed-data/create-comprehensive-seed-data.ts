...
const departments = [
  ...
  {
    name: 'Construction',
    description: 'Construction management and field services',
  },
  {
    name: 'Administrative',
    description: 'Project management, finance, HR, IT',
  },
];
...
const designUsers = [
  {
    email: 'james.wong@faevision.com',
    name: 'James Wong',
    role: 'CONTRIBUTOR',
    department: 'Design',
    title: 'Senior Architect - Custom Homes',
  },
  {
    email: 'maria.garcia@faevision.com',
    name: 'Maria Garcia',
    role: 'CONTRIBUTOR',
    department: 'Design',
    title: 'Senior Architect - Production',
  },
  {
    email: 'robert.kim@faevision.com',
    name: 'Robert Kim',
    role: 'CONTRIBUTOR',
    department: 'Design',
  ...
  {
    email: 'jennifer.lee@faevision.com',
    name: 'Jennifer Lee',
    role: 'CONTRIBUTOR',
    department: 'Design',
    title: 'BIM Manager',
  ...
  {
    email: 'michael.brown@faevision.com',
    name: 'Michael Brown',
    role: 'CONTRIBUTOR',
    department: 'Design',
  ...
  {
    email: 'amy.johnson@faevision.com',
    name: 'Amy Johnson',
    role: 'CONTRIBUTOR',
    department: 'Design',
  ...
  {
    email: 'kevin.davis@faevision.com',
    name: 'Kevin Davis',
    role: 'CONTRIBUTOR',
    department: 'Design',
    title: 'Project Architect',
  ...
  {
    email: 'rachel.miller@faevision.com',
    name: 'Rachel Miller',
    role: 'CONTRIBUTOR',
    department: 'Design',
    title: 'Project Architect',
  ...
  {
    email: 'jason.wilson@faevision.com',
    name: 'Jason Wilson',
    role: 'CONTRIBUTOR',
    department: 'Design',
  ...
  {
    email: 'stephanie.moore@faevision.com',
  ...
  {
    email: 'daniel.taylor@faevision.com',
    name: 'Daniel Taylor',
    role: 'CONTRIBUTOR',
    department: 'Design',
    title: 'Architectural Designer',
  ...
  {
    email: 'laura.anderson@faevision.com',
    name: 'Laura Anderson',
    role: 'CONTRIBUTOR',
    department: 'Design',
    title: 'Architectural Designer',
  ...
  {
    email: 'thomas.white@faevision.com',
    name: 'Thomas White',
    role: 'CONTRIBUTOR',
    department: 'Design',
  ...
  {
    email: 'patricia.harris@faevision.com',
  ...
  {
    email: 'christopher.martin@faevision.com',
...
const engineeringUsers = [
  {
    email: 'richard.thompson@faevision.com',
  ...
  {
    email: 'susan.jackson@faevision.com',
    name: 'Susan Jackson',
    role: 'CONTRIBUTOR',
    department: 'Engineering',
  ...
  {
    email: 'paul.white@faevision.com',
    name: 'Paul White',
    role: 'CONTRIBUTOR',
    department: 'Engineering',
  ...
  {
    email: 'karen.lewis@faevision.com',
    name: 'Karen Lewis',
    role: 'CONTRIBUTOR',
    department: 'Engineering',
  ...
  {
    email: 'steven.hall@faevision.com',
    name: 'Steven Hall',
    role: 'CONTRIBUTOR',
    department: 'Engineering',
  ...
  {
    email: 'michelle.allen@faevision.com',
    name: 'Michelle Allen',
    role: 'CONTRIBUTOR',
    department: 'Engineering',
    title: 'Structural Engineer',
  ...
  {
    email: 'brian.young@faevision.com',
    name: 'Brian Young',
    role: 'CONTRIBUTOR',
    department: 'Engineering',
    title: 'Structural Engineer',
  ...
  {
    email: 'angela.hernandez@faevision.com',
  ...
  {
    email: 'donna.wright@faevision.com',
    name: 'Donna Wright',
    role: 'CONTRIBUTOR',
    department: 'Engineering',
    title: 'MEP Engineer',
  ...
  {
    email: 'gary.lopez@faevision.com',
    name: 'Gary Lopez',
    role: 'CONTRIBUTOR',
    department: 'Engineering',
    title: 'MEP Engineer',
  ...
  {
    email: 'helen.scott@faevision.com',
    name: 'Helen Scott',
    role: 'CONTRIBUTOR',
    department: 'Engineering',
...
const constructionUsers = [
  {
    email: 'william.green@faevision.com',
    name: 'William Green',
    role: 'CONTRIBUTOR',
    department: 'Construction',
    title: 'Construction Manager - Production',
  },
  {
    email: 'nancy.adams@faevision.com',
    name: 'Nancy Adams',
    role: 'CONTRIBUTOR',
    department: 'Construction',
    title: 'Construction Manager - Custom',
  },
  {
    email: 'ronald.baker@faevision.com',
    name: 'Ronald Baker',
    role: 'CONTRIBUTOR',
    department: 'Construction',
  ...
  {
    email: 'betty.gonzalez@faevision.com',
    name: 'Betty Gonzalez',
    role: 'CONTRIBUTOR',
    department: 'Construction',
  ...
  {
    email: 'kenneth.nelson@faevision.com',
    name: 'Kenneth Nelson',
    role: 'CONTRIBUTOR',
    department: 'Construction',
    title: 'Field Engineer',
  ...
  {
    email: 'sarah.carter@faevision.com',
    name: 'Sarah Carter',
    role: 'CONTRIBUTOR',
    department: 'Construction',
    title: 'Field Engineer',
  ...
  {
    email: 'anthony.mitchell@faevision.com',
  ...
  {
    email: 'lisa.perez@faevision.com',
    name: 'Lisa Perez',
    role: 'CONTRIBUTOR',
    department: 'Construction',
    title: 'Construction Coordinator',
  ...
  {
    email: 'edward.roberts@faevision.com',
    name: 'Edward Roberts',
    role: 'CONTRIBUTOR',
    department: 'Construction',
  ...
  {
    email: 'sandra.turner@faevision.com',
    name: 'Sandra Turner',
    role: 'CONTRIBUTOR',
    department: 'Construction',
    title: 'Quality Inspector',
...
const administrativeUsers = [
  {
    email: 'joseph.phillips@faevision.com',
    name: 'Joseph Phillips',
    role: 'CONTRIBUTOR',
    department: 'Administrative',
    title: 'Project Manager - Custom',
  },
  {
    email: 'carol.campbell@faevision.com',
    name: 'Carol Campbell',
    role: 'CONTRIBUTOR',
    department: 'Administrative',
    title: 'Project Manager - Custom',
  ...
  {
    email: 'matthew.parker@faevision.com',
    name: 'Matthew Parker',
    role: 'CONTRIBUTOR',
    department: 'Administrative',
  ...
  {
    email: 'ruth.evans@faevision.com',
    name: 'Ruth Evans',
    role: 'CONTRIBUTOR',
    department: 'Administrative',
    title: 'Project Manager - Production',
  ...
  {
    email: 'frank.edwards@faevision.com',
    name: 'Frank Edwards',
    role: 'CONTRIBUTOR',
    department: 'Administrative',
  ...
  {
    email: 'sharon.collins@faevision.com',
    name: 'Sharon Collins',
    role: 'CONTRIBUTOR',
    department: 'Administrative',
    title: 'HR Manager',
  ...
  {
    email: 'gregory.stewart@faevision.com',
  ...
  {
    email: 'dorothy.sanchez@faevision.com',
    name: 'Dorothy Sanchez',
    role: 'CONTRIBUTOR',
    department: 'Administrative',
    title: 'Admin Coordinator',
  },
  {
    email: 'jerry.morris@faevision.com',
    name: 'Jerry Morris',
    role: 'CONTRIBUTOR',
    department: 'Administrative',
    title: 'Admin Coordinator',
...
const initiatives = [
  {
    ...
    description:
      'Reduce rework and improve construction quality across all projects',
    goals: {
  ...
  },
  {
    ...
    description:
      'Streamline design coordination to reduce conflicts and delays',
    goals: {
    ...
    signals: [
      {
        ...
        description:
          'Framing inspection failed for Unit 24B due to improper joist spacing. Requires 16 hours of rework and 2-day delay.',
        severity: 'HIGH',
        department: 'Construction',
      ...
      },
      {
        ...
        description:
          'Waterproofing membrane applied incorrectly on Units 15-18, discovered during inspection.',
        severity: 'CRITICAL',
        department: 'Construction',
        team: 'Quality Control',
      ...
      },
      {
        ...
        description:
          'Multiple code violations found in electrical rough-in inspection - improper GFCI placement.',
        severity: 'HIGH',
        department: 'Construction',
        team: 'Quality Control',
    ...
    signals: [
      {
        ...
        description:
          'AutoCAD drawing coordination error - plumbing conflicts with HVAC ducting in master bath layout.',
        severity: 'MEDIUM',
        department: 'Design',
      ...
      },
      {
        ...
        description:
          'Steel beam placement conflicts with electrical and plumbing routes in kitchen area.',
        severity: 'HIGH',
        department: 'Engineering',
    ...
    signals: [
      {
        ...
        description:
          'City planning department introduced new stormwater management requirements affecting all pending projects.',
        severity: 'CRITICAL',
        department: 'Engineering',
      ...
      },
      {
        ...
        description:
          'Permit review delayed due to questions about ADA compliance in common areas.',
        severity: 'MEDIUM',
        department: 'Design',
    ...
    signals: [
      {
        ...
        description:
          'Client requesting significant kitchen layout modifications after design approval.',
        severity: 'MEDIUM',
        department: 'Design',
        team: 'Project Architects',
        project: 'Premier Custom - Executive Estates',
    ...
    signals: [
      {
        ...
        description:
          'Primary concrete supplier experiencing delivery delays due to equipment failure.',
        severity: 'HIGH',
        department: 'Construction',
...
async function createOrganizationalStructure() {
  ...
  try {
    ...
    if (departmentModel) {
      ...
      console.log(
        '  ⚠️ Department model not available (using legacy structure)'
      );
    }
  } catch (error) {
...
async function createUsers() {
  ...
  for (const userData of allUsers) {
    const hashedPassword = await bcrypt.hash(
      (userData as any).password || 'defaultpass123',
      12
    );
...
async function main() {
  try {
    ...
    console.log('📊 Summary:');
    console.log(
      `  👥 Users: ${coreUsers.length + designUsers.length + engineeringUsers.length + constructionUsers.length + administrativeUsers.length}`
    );
