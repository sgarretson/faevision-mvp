...
class FAEVisionLinearSetup {
  constructor() {
    this.configPath = path.join(
      __dirname,
      '../linear-workspace-setup/linear-workspace-config.yaml'
    );
    this.workspaceName = 'FAEVision MVP';
    this.description =
      'Internal application for 50 executives - 11-week delivery';
  }
  ...
  displaySetupInstructions() {
    ...
    console.log(
      'Following our documented Linear Expert process, please complete these steps:\n'
    );
    ...
    console.log(
      '4. Description: "Internal application for 50 executives - 11-week delivery"\n'
    );
  ...
  displayEpicStructure() {
    ...
    console.log(
      '1. Create issue: "FAE-001 - Epic 0: Environment & Tools Setup"'
    );
    console.log('2. Set as Epic type');
    console.log('3. Assign to Epic 0');
    console.log(
      '4. Add description from: linear-workspace-setup/epic-0-master-issue.md'
    );
    console.log(
      '5. Create sub-issues for each expert (FAE-002 through FAE-012)'
    );
  }
  ...
  displayIntegrationSetup() {
    ...
    console.log(
      '  - Configure branch naming: feature/FAE-{issue-number}-{description}'
    );
    console.log('');
