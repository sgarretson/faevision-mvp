...
const VERCEL_PRISMA_URL = process.env.DATABASE_URL || 'postgres://f279b9e46e7c0166b4949c4f910079cd6f0cbb7ae03a783a14b933638f1ba0ce:sk_paIQiDGXmKNC6q0ngZD0i@db.prisma.io:5432/postgres?sslmode=require'
...
async function main() {
  try {
    ...
    console.log(`🗄️ Database: ${VERCEL_PRISMA_URL.split('@')[1]?.split('/')[0]}`)
    console.log('')
    ...
    console.log('1. Test Preview environment: https://faevision-simplified-git-preview.vercel.app')
