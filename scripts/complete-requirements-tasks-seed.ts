...
async function main() {
  ...
  try {
    ...
    for (const solution of solutions) {
      ...
      console.log(
        `  ✅ ${solution.id}: Created ${requirements.length} requirements`
      );
    }
    ...
    const cadRequirements = [
      {
        ...
        description:
          'Conduct comprehensive assessment of current CAD workstation hardware capabilities and identify upgrade requirements for optimal performance.',
        type: 'TECHNICAL',
        priority: 'HIGH',
        status: 'APPROVED',
        solutionId: solution.id,
        acceptanceCriteria:
          'Complete hardware audit report with specific upgrade recommendations and cost analysis.',
        businessValue:
      ...
      },
      {
        ...
        description:
          'Verify software licensing requirements and ensure compatibility between upgraded hardware and existing CAD software suite.',
        type: 'BUSINESS',
        priority: 'HIGH',
        status: 'IN_PROGRESS',
        solutionId: solution.id,
        ...
        businessValue:
          'Prevents costly licensing issues and ensures seamless CAD operations during transition.',
        estimatedHours: 24,
      ...
      },
      {
        ...
        description:
          'Develop comprehensive data migration plan and backup strategy to ensure zero data loss during CAD system upgrades.',
        type: 'TECHNICAL',
        priority: 'CRITICAL',
        status: 'DRAFT',
        solutionId: solution.id,
        ...
        businessValue:
          'Protects critical design data and minimizes business disruption during upgrades.',
        estimatedHours: 32,
      ...
      },
      {
        ...
        description:
          'Design and implement training program for staff on upgraded CAD systems and new workflow procedures.',
        type: 'BUSINESS',
        priority: 'MEDIUM',
        status: 'DRAFT',
        solutionId: solution.id,
        acceptanceCriteria:
          'Training program delivered to 100% of CAD users with competency verification.',
        businessValue:
          'Ensures rapid adoption and maximizes productivity benefits of CAD upgrades.',
        estimatedHours: 56,
    ...
    const developmentRequirements = [
      {
        ...
        description:
          'Develop comprehensive competency assessment framework to evaluate junior staff skills and identify specific development needs.',
        type: 'BUSINESS',
        priority: 'HIGH',
        status: 'APPROVED',
        solutionId: solution.id,
      ...
      },
      {
        ...
        description:
          'Design formal mentorship program pairing junior staff with senior professionals for knowledge transfer and career guidance.',
        type: 'BUSINESS',
        priority: 'HIGH',
        status: 'IN_PROGRESS',
        solutionId: solution.id,
      ...
      },
      {
        ...
        description:
          'Implement performance tracking system and clear career progression pathways for junior staff development.',
        type: 'BUSINESS',
        priority: 'MEDIUM',
        status: 'DRAFT',
        solutionId: solution.id,
        acceptanceCriteria:
          'Performance tracking system with defined career progression milestones and criteria.',
        businessValue:
          'Improves retention and provides clear advancement opportunities for junior staff.',
        estimatedHours: 40,
      ...
      },
      {
        ...
        description:
          'Establish framework for progressive project assignments that build junior staff capabilities while maintaining quality standards.',
        type: 'BUSINESS',
        priority: 'HIGH',
        status: 'DRAFT',
        solutionId: solution.id,
        acceptanceCriteria:
          'Project assignment framework with complexity levels and supervision requirements.',
        businessValue:
          'Optimizes junior staff utilization while maintaining project quality and client satisfaction.',
        estimatedHours: 28,
...
async function createTasksForRequirement(requirement: any) {
  ...
  for (const taskData of taskTemplates) {
    try {
      ...
      console.warn(
        `⚠️ Failed to create task for requirement ${requirement.id}:`,
        error.message
      );
    }
  }
...
async function verifyCompleteWorkflow() {
  ...
  console.log(
    `  ✅ Requirements linked to Solutions: ${requirementsWithSolutions}/${stats.requirements}`
  );
  console.log(
    `  ✅ Tasks linked to Requirements: ${tasksWithRequirements}/${stats.tasks}`
  );
