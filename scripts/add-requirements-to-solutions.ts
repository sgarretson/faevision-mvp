...
async function main() {
  ...
  try {
    ...
    console.log(`✅ solution_001: Added ${solution1Requirements.length} requirements`);
    ...
    console.log(`✅ solution_002: Added ${solution2Requirements.length} requirements`);

    const totalRequirements = solution1Requirements.length + solution2Requirements.length;
    ...
    solutions.forEach((solution: any) => {
      ...
      console.log(`📋 ${solution.id}: ${reqCount} requirements, ${taskCount} tasks`);
    });
