...
const developmentCredentials = {
  ...
  POSTGRES_URL_NON_POOLING:
    'postgresql://neondb_owner:npg_6vcJmQuOek5X@ep-lingering-queen-ae13d5gh.c-2.us-east-2.aws.neon.tech/neondb?sslmode=require',
  POSTGRES_PRISMA_URL:
    'postgresql://neondb_owner:npg_6vcJmQuOek5X@ep-lingering-queen-ae13d5gh-pooler.c-2.us-east-2.aws.neon.tech/neondb?connect_timeout=15&sslmode=require',
  POSTGRES_URL_NO_SSL:
    'postgresql://neondb_owner:npg_6vcJmQuOek5X@ep-lingering-queen-ae13d5gh-pooler.c-2.us-east-2.aws.neon.tech/neondb',
...
function displayEnvironmentSummary() {
  ...
  console.log('\n🔵 PREVIEW Environment:');
  console.log(
    '   Host: ep-round-frost-aecda5ou-pooler.c-2.us-east-2.aws.neon.tech'
  );
  ...
  console.log(
    '   Host: ep-lingering-queen-ae13d5gh-pooler.c-2.us-east-2.aws.neon.tech'
  );
...
function generateVercelEnvironmentConfig() {
  ...
  const vercelConfig = [
    ...
    { name: 'DIRECT_URL', value: developmentCredentials.DIRECT_URL },
    {
      ...
      value: developmentCredentials.POSTGRES_PRISMA_URL,
    },
    {
      name: 'NEXT_PUBLIC_STACK_PROJECT_ID',
      value: developmentCredentials.NEXT_PUBLIC_STACK_PROJECT_ID,
    },
    {
      name: 'NEXT_PUBLIC_STACK_PUBLISHABLE_CLIENT_KEY',
      value: developmentCredentials.NEXT_PUBLIC_STACK_PUBLISHABLE_CLIENT_KEY,
    },
    {
      name: 'STACK_SECRET_SERVER_KEY',
      value: developmentCredentials.STACK_SECRET_SERVER_KEY,
    },
  ...
  vercelConfig.forEach(config => {
    console.log(
      `   ${config.name}: ${config.value.substring(0, 50)}${config.value.length > 50 ? '...' : ''}`
    );
  });
