...
const sampleInputs = [
  {
    ...
    rootCause: 'Lack of standardized communication protocols and centralized tracking system',
  ...
  },
  {
    ...
    rootCause: 'Insufficient historical data analysis and unrealistic scope estimation',
