...
import { generateEmbedding, extractEntities, generateTags } from '@/lib/ai/signal-processing';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log(`  🎉 Signal enrichment complete: ${processedCount} signals processed`);
...
export async function GET() {
  return POST(new NextRequest('http://localhost/api/jobs/enrich-signals', { method: 'POST' }));
}
