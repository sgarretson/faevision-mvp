      ...
      <div className="relative">
        <div className="mx-auto max-w-7xl px-6 py-24">
          <div className="text-center">
            <div className="mb-8">
              <h1 className="mb-6 text-balance text-6xl font-bold text-white">
                FAEVision
              </h1>
              ...
              <div className="mx-auto max-w-3xl text-lg text-blue-200">
                Empowering architecture and engineering firms with collaborative
                strategic intelligence, executive decision-making tools, and
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-base text-neutral-700">
              Sprint 1 MVP delivers three critical features for executive
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="rounded-lg border border-neutral-200 bg-white p-8 text-center shadow-sm transition-shadow duration-200 hover:shadow-md">
              ...
              <p className="mb-6 text-base text-neutral-700">
                Strategic input creation with comprehensive tagging, priority
                management, and executive-optimized workflows for operational
                insights.
              </p>
              <Link
                href="/inputs/create"
                className="inline-flex items-center justify-center rounded-lg border border-blue-500 bg-white px-6 py-3 font-medium text-blue-500 transition-colors hover:bg-blue-50"
              >
                Create Input
              </Link>
            </div>
            ...
            <div className="rounded-lg border border-neutral-200 bg-white p-8 text-center shadow-sm transition-shadow duration-200 hover:shadow-md">
              ...
              <p className="mb-6 text-base text-neutral-700">
                Real-time voting, threaded commenting, @mentions, and activity
                feeds for executive team collaboration and consensus building.
              </p>
              <Link
                href="/inputs"
                className="inline-flex items-center justify-center rounded-lg border border-blue-500 bg-white px-6 py-3 font-medium text-blue-500 transition-colors hover:bg-blue-50"
            ...
            <div className="rounded-lg border border-neutral-200 bg-white p-8 text-center shadow-sm transition-shadow duration-200 hover:shadow-md">
              ...
              <p className="mb-6 text-base text-neutral-700">
                Executive dashboard with comprehensive analytics, pattern
                recognition, and data-driven decision support for strategic
                oversight.
              </p>
              <Link
                href="/dashboard"
            ...
            <div>
              ...
              <div className="space-y-4 text-base text-neutral-700">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <strong>Strategic Intelligence:</strong> Comprehensive
                    analytics and insights for data-driven executive
                    decision-making
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="font-bold text-green-600">✓</div>
                  <div>
                    <strong>Real-time Collaboration:</strong> Advanced voting,
                    commenting, and team engagement tools for consensus building
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="font-bold text-green-600">✓</div>
                  <div>
                    <strong>Mobile Executive:</strong> Responsive design
                    optimized for executive mobility and meeting-friendly
                    workflows
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="font-bold text-green-600">✓</div>
                  <div>
                    <strong>Professional Security:</strong> Role-based access
                    control and enterprise-grade authentication systems
                  </div>
                </div>
              </div>
            </div>
